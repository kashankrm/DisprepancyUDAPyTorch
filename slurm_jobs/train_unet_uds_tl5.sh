...
python ${jobFile}.py --exp-name unet_transfer_learning_5pt \
--gpu-id 0 \
--loss-func Dice \
--batch-size 12 \
--model-arch Unet \
...
--data-list-train /isi/w/lb27/data/PAG_segmentation/processed/semantic_segmentation/real_data/nital_pag_no_overlap_comb/perc_val/5/train_list.txt \
--data-list-validation /isi/w/lb27/data/PAG_segmentation/processed/semantic_segmentation/real_data/nital_pag_no_overlap_comb/perc_val/5/val_list.txt \
