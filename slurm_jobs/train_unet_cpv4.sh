...
python ${jobFile}.py --exp-name unet_cpv4 \
--gpu-id 0 \
--batch-size 12 \
--num-iterations 100000 \
--val-every-it 200 \
--data-dir-image /isi/w/lb27/data/PAG_segmentation/raw/semantic_segmentation/SynLOM_multi_cut_paste_v4/images \
--data-dir-label /isi/w/lb27/data/PAG_segmentation/raw/semantic_segmentation/SynLOM_multi_cut_paste_v4/masks \
--data-list-train /isi/w/lb27/data/PAG_segmentation/raw/semantic_segmentation/SynLOM_multi_cut_paste_v4/train_list.txt \
--data-list-validation /isi/w/lb27/data/PAG_segmentation/raw/semantic_segmentation/SynLOM_multi_cut_paste_v4/val_list.txt \
